...
-   ***Questions for Discussion***
    ...
    1.  With the code files, the errors were minimal. Once file paths were updated and I corrected the factor variable issue with the regression, it worked as intended.
